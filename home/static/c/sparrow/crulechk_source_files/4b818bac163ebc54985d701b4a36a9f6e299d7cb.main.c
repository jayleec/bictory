#include "0af62732faeed640032329c48304a3dceb9efa72.sub.h"
#include "37a286eda5cad37295e6d19afe761ce6aed488b3.duplicate_header.h"
#include "07347c8290d0d5acbf24361ea9c394cf84ea7fb9.main.h"
...
int CERT_SCS_STR33_C()
{
	...
	wchar_t * t_wide_str3 = (wchar_t *)malloc((wcslen(wide_str1) + 1) * sizeof(wchar_t)); // ���� ũ�⸦ �������.

	t_wide_str1 = (wchar_t *)malloc(strlen(char_str1) + 1);
	t_wide_str2 = (wchar_t *)malloc(wcslen(wide_str1) + 1);						
	t_wide_str3 = (wchar_t *)malloc((wcslen(wide_str1) + 1) * sizeof(wchar_t)); // ���� ũ�⸦ �������.
...
{
	/*
		printf, scanf, fprintf, fscanf�� ����ؾߵȴ�.
		������� �ʾƼ� alarm �߻�.
	*/
	//printf();
	//scanf();
...
etk_const_routine_addr_start		�Լ� ������ 

# 1 "/home/kskyj/sparrow4/util/testcode/c/WEAK_ENCRYPTION.INSUFFICIENT_KEY.c"
...
# 3 "/home/kskyj/sparrow4/util/testcode/c/WEAK_ENCRYPTION.INSUFFICIENT_KEY.c" 2
...
# 4 "/home/kskyj/sparrow4/util/testcode/c/WEAK_ENCRYPTION.INSUFFICIENT_KEY.c" 2
...
void badKey1() {
 RSA * rsa;
 rsa = RSA_generate_key(512, 35, ((void *)0), ((void *)0));
 if(rsa == ((void *)0)) {
  printf("Error\n");
 }
}
...
void badKey2() {
 RSA * rsa;
 int keyLength = 512;
 rsa = RSA_generate_key(keyLength, 35, ((void *)0), ((void *)0));
 if(rsa == ((void *)0)) {
  printf("Error\n");
 }
}
...
void goodKey() {
 RSA * rsa;
 rsa = RSA_generate_key(1024, 35, ((void *)0), ((void *)0));
 if(rsa == ((void *)0)) {
  printf("Error\n");
 }
}

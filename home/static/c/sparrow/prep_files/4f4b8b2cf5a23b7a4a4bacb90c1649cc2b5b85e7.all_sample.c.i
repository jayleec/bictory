# 1 "/home/kskyj/sparrow4/util/testcode/c/all_sample.c"
...
# 2 "/home/kskyj/sparrow4/util/testcode/c/all_sample.c" 2
...
# 3 "/home/kskyj/sparrow4/util/testcode/c/all_sample.c" 2
...
# 4 "/home/kskyj/sparrow4/util/testcode/c/all_sample.c" 2
...
void buffer_overrun_complex_01_main(char c) {
    char buf[5];
    buf[buffer_overrun_complex_01_sub()] = c;
}
...
void buffer_overrun_02_main() {
    ...
    char buff1[5];
    char buff2[10];
    strcpy(str.buf1, str.buf2);
    memcpy(buff1, buff2, sizeof(buff2));
}
...
void buffer_overrun_complex_02_main() {
    ...
    char buff1[5];
    char buff2[10];
    strncpy(buff1, buff2, buffer_overrun_complex_02_sub());
}
...
int memory_leak_01_main(size_t size) {
    ...
    char *ptr;
    if (memory_leak_01_sub(&srl.p, size) ) {
        ptr = srl.p;
        free(ptr);
        return 2;
    }
...
char pass_by_value(struct big_number b) {
    return b.low[0];
}
...
fp_dangerous_func_cast_main = (int(*)())dangerous_func_cast_sub;
}
...
# 642 "/home/kskyj/sparrow4/util/testcode/c/all_sample.c"
int testField;


missing_function_return(float a){
 float b = 2.1;
 b += a;
return b;
}

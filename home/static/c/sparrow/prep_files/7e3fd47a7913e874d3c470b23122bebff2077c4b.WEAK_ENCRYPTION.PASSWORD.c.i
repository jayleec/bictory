# 1 "/home/kskyj/sparrow4/util/testcode/c/WEAK_ENCRYPTION.PASSWORD.c"
...
# 3 "/home/kskyj/sparrow4/util/testcode/c/WEAK_ENCRYPTION.PASSWORD.c" 2
...
int dbaccess(char * server, char * user, char * cpw, RSA * rsa) {
 ...
 RSA_private_decrypt(strlen(cpw), cpw, pw, rsa, 0);
 SQLConnect(hdbc, (SQLCHAR *)server, strlen(server), user, strlen(user), pw, strlen(pw));
 return 0;
}

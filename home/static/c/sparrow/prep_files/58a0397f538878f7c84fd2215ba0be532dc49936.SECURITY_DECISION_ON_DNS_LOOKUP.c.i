# 1 "/home/kskyj/sparrow4/util/testcode/c/SECURITY_DECISION_ON_DNS_LOOKUP.c"
...
# 3 "/home/kskyj/sparrow4/util/testcode/c/SECURITY_DECISION_ON_DNS_LOOKUP.c" 2
...
# 4 "/home/kskyj/sparrow4/util/testcode/c/SECURITY_DECISION_ON_DNS_LOOKUP.c" 2
...
# 5 "/home/kskyj/sparrow4/util/testcode/c/SECURITY_DECISION_ON_DNS_LOOKUP.c" 2
...
int decision(char * ip_addr_string) {
 ...
 hp = (struct hostent *)gethostbyaddr((char *)&myaddr, sizeof(struct in_addr), 0);
 char * cloneName;
 hpClone = hp;
 cloneName = hp->h_name;
 if(hp && !strncmp(hp->h_name, tHost, sizeof(tHost))) {
  return 1;
 } else if(hp && !strncmp(cloneName, tHost, sizeof(tHost))) {
  return 0;
 } else if(hpClone && !strncmp(hpClone->h_name, tHost, sizeof(tHost))) {
  return -1;
 }
}

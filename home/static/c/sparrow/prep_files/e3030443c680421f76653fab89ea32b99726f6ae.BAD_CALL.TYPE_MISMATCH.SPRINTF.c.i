# 1 "/home/kskyj/sparrow4/util/testcode/c/BAD_CALL.TYPE_MISMATCH.SPRINTF.c"
...
# 4 "/home/kskyj/sparrow4/util/testcode/c/BAD_CALL.TYPE_MISMATCH.SPRINTF.c" 2

void func() {
 char dest[100];
 char src1[100];
 char src2[100];
 sprintf(dest, "%50s%100s", src1, src2);
}

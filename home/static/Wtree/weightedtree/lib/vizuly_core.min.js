...
vizuly.version = "1.0", vizuly.ui = {}, vizuly.viz = {}, vizuly.viz.layout = {}, vizuly.viz.layout.CLUSTERED = "CLUSTERED", vizuly.viz.layout.STACKED = "STACKED", vizuly.viz.layout.OVERLAP = "OVERLAP", vizuly.viz.layout.STREAM = "STREAM", vizuly.color = {}, vizuly.color.shift = function(a, b) {
    ...
    vizuly.theme.weighted_tree = function(a) {
        ...
        function c() {
            if (o) {
                var b = a.selection();
                j = Math.max(8, Math.round(a.width() / 75)),
                    b.selectAll(".vz-weighted_tree-node circle").style("stroke", function(a) {
        ...
        if (o && a.data()) {
            ...
            a.children()(b).forEach(function(a, b) {
                if(a.depth == 1)
                    ...
                    a.vz_link_color = o.link_colors[8], e(a)
                else if(a.depth == 3)
                    a.vz_link_color = o.link_colors[2], e(a)
                else if(a.depth == 4)
                    a.vz_link_color = o.link_colors[4], e(a)
            }), l = !1, m = !1
         }
        }
    ...
    function e(b) {
        a.children()(b) && a.children()(b).forEach(function(a) {
            if(a.depth == 1)
                a.vz_link_color = b.vz_link_color[3]
            else if(a.depth == 2)
                    a.vz_link_color = o.link_colors[8], e(a)
            else if(a.depth == 3)
                    a.vz_link_color = o.link_colors[2], e(a)
